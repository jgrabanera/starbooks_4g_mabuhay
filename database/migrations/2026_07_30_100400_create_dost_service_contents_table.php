...
return new class extends Migration
{
    ...
    {
        Schema::create('dost_service_contents', function (Blueprint $table) {
            $table->id();
        ...
        $this->copyLegacyRecords('dost-services', 'dost_service_contents');
    }

    public function down(): void
    {
        Schema::dropIfExists('dost_service_contents');
    }
