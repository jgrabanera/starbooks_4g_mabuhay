...
return new class extends Migration
{
    ...
    {
        Schema::create('social_service_contents', function (Blueprint $table) {
            $table->id();
        ...
        $this->copyLegacyRecords('social-services', 'social_service_contents');
    }

    public function down(): void
    {
        Schema::dropIfExists('social_service_contents');
    }
