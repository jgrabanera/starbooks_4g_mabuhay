...
const AboutLguMabuhay = () => {
    const tabs = [
        { id: "about", label: "About LGU Mabuhay", number: "1" },
        { id: "structure", label: "Organizational Structure", number: "2" },
                        ...
                        >
                            {tabs.map((tab) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* insteadt of number. use an icon */}
                                        <span
                                        ...
                                        <span className="text-sm font-bold uppercase tracking-[0.08em] py-2">
                                            {tab.label}
                                        </span>
                                    </button>
                                );
